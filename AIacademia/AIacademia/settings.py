...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.contrib.messages.context_processors.messages','academia_app.context_processors.admin_dashboard_context',
            ],
        },
    },
]
...
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'course_recommendation'
LOGOUT_REDIRECT_URL = 'course_recommendation'
CSRF_FAILURE_VIEW = 'academia_app.views.custom_csrf_failure'
