...
for course in all_courses:
    course_obj = {
        ...
        "Course Objectives Sentence Count": len(sent_tokenize(course.Course_objectives)),
        "Course General Info Sentence Count": len(sent_tokenize(course.Course_general_info_and_about))
    }
