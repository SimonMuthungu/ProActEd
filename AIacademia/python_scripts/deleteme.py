...
#     byte_objectives = byte_vector.course_objectives.encode('utf-8')
#     byte_general_info = byte_vector.course_general_info_and_about.encode('utf-8')
#     print(type(byte_objectives))
#     print(type(byte_general_info))
...
# re-running the recommender to get the course vectors and store them
...
#   import nltk
    ...
    # Access the column
    vectors_column = df['Concatenated Avg Pooled Objective Vectors']

    # Convert the strings to NumPy arrays and calculate dimensions
    vector_dimensions = vectors_column.apply(lambda x: len(np.fromstring(x[1:-1], sep=' ')))

    # Print the dimensions
    print(vector_dimensions)

    # writing these vectors in the database table number vectors
    # from academia_app.models import Recommender_training_data_number_vectors

    # for index, row in df.iterrows():
    # # Create an instance of the model and populate it
    #     instance = Recommender_training_data_number_vectors(
    ...
    print('Data written to the table! Cancel now')
